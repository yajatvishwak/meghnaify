...
<section class="h-screen bg-black text-white grid place-items-center overflow-hidden ">
    ...
    <div class="z-10 max-w-screen-sm p-10">
        ...
        <div class="text-7xl text-center mt-10 flex items-center justify-between">
            ...
            {/if}
            <div on:click={add} class="p-4 rounded-full hover:bg-gray-800 transition-all">
